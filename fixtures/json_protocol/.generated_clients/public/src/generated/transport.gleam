...
@external(javascript, "./transport_ffi.mjs", "ensureSocket")
...
@external(javascript, "./transport_ffi.mjs", "registerPushHandler")
...
@external(javascript, "./transport_ffi.mjs", "registerOnConnect")
pub fn register_on_connect(callback: fn() -> Nil) -> Nil

/// Register a callback that fires when the WebSocket disconnects.
@external(javascript, "./transport_ffi.mjs", "registerOnDisconnect")
