...
//// - types.gleam — mirrored page types (ToBackend, ToFrontend)
...
//// Each page's ToBackend and ToFrontend types are replicated
...
fn emit_page_type_block(
  ...
  let to_backend = emit_type_def(prefix <> "ToBackend", contract.to_backend_variants)
  let to_frontend = emit_type_def(prefix <> "ToFrontend", contract.to_frontend_variants)
    ...
    case contract.has_model {
      ...
      True -> {
        ...
        Ok(
          "/// Encode a "
          <> prefix
          <> " ToBackend message to ETF binary.\n"
          <> "pub fn encode_"
          <> fn_suffix
          <> "_to_backend(msg: "
          <> prefix
    ...
    case contract.has_model {
      ...
      True -> {
        ...
        Ok(
          "/// Decode a "
          <> prefix
          <> " ToFrontend message from ETF binary.\n"
          <> "pub fn decode_"
          <> fn_suffix
