...
fn app_gleam(
  ...
  let route_variants = generate_route_view_arms(routes, has_client_context)
  ...
  let render_page_call = case has_client_context {
    True -> "render_page(model.route, model.client_context)"
    False -> "render_page(model.route)"
  }
