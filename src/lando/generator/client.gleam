...
fn init(_flags: Nil) -> #(Model, Effect(Msg)) {
  #(Model(connection: Disconnected, loading: False, toasts: []),
    init_transport())
}
...
fn view(model: Model) -> Element(Msg) {
  html.div([attr.class(\"lando-app\")], [
    ...
    // Page content is rendered by the generated page view dispatch.
    // Placeholder until client-side page views are generated (bean after ETF codec).
    html.div([], [html.text(\"Lando\")]),
