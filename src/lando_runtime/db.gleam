...
@external(erlang, "lando_runtime_db_ffi", "add_db_timing")
fn add_db_timing(elapsed_ms: Int) -> Nil

@external(erlang, "lando_runtime_db_ffi", "get_db_timing")
fn get_db_timing() -> #(Int, Int)

@external(erlang, "lando_runtime_db_ffi", "init_db_timing")
