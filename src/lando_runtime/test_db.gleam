...
@external(erlang, "lando_runtime_test_db_ffi", "pt_get")
fn pt_get(
  key: String,
...
fn template_db(migrations_dir: String) -> sqlight.Connection {
  let cache_key = "lando_test_template:" <> migrations_dir
