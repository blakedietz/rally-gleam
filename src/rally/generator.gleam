...
/// based on protocol (ETF re-exports from rpc_ffi.mjs, JSON from json/wire_ffi.mjs).
pub fn generate_protocol_wire_js(protocol: String) -> String {
  let import_path = case protocol {
    "json" -> "\"../../libero/libero/json/wire_ffi.mjs\""
    _ -> "\"../../libero/libero/rpc_ffi.mjs\""
  }
  "// Generated by Rally — do not edit.\n"
  <> "export { encode_request, decode_server_frame, encode_flags, decode_flags_typed, identity } from "
  <> import_path
  <> ";\n"
}
