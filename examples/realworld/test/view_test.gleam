...
fn logged_in_ctx() -> ClientContext {
  ClientContext(current_user: Some(User(username: "jake", image: "https://i.imgur.com/test.jpg")))
}

pub fn home_logged_out_view_test() {
  let model = home_.Model(
    articles: [],
    tags: [],
